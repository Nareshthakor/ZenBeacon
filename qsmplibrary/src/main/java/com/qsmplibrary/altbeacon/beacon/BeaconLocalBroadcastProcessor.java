...
public class BeaconLocalBroadcastProcessor {
    ...
    public static final String RANGE_NOTIFICATION = "com.qsmplibrary.altbeacon.beacon.range_notification";
    public static final String MONITOR_NOTIFICATION = "com.qsmplibrary.altbeacon.beacon.monitor_notification";
