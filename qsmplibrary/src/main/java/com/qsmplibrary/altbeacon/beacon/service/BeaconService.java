...
import com.qsmplibrary.BuildConfig;
import com.qsmplibrary.altbeacon.beacon.Beacon;
import com.qsmplibrary.altbeacon.beacon.BeaconLocalBroadcastProcessor;
...
import com.qsmplibrary.altbeacon.beacon.distance.DistanceCalculator;
import com.qsmplibrary.altbeacon.beacon.distance.ModelSpecificDistanceCalculator;
import com.qsmplibrary.altbeacon.beacon.logging.LogManager;
import com.qsmplibrary.altbeacon.beacon.service.scanner.CycledLeScanCallback;
import com.qsmplibrary.altbeacon.beacon.startup.StartupBroadcastReceiver;
import com.qsmplibrary.altbeacon.beacon.utils.ProcessUtils;
import com.qsmplibrary.altbeacon.bluetooth.BluetoothCrashResolver;
                ...
                if (startRMData != null) {
                    switch (msg.what) {
                        case MSG_START_RANGING:
                            ...
                            service.startRangingBeaconsInRegion(startRMData.getRegionData(), new com.qsmplibrary.altbeacon.beacon.service.Callback(startRMData.getCallbackPackageName()));
                        ...
                        case MSG_START_MONITORING:
                            ...
                            service.startMonitoringBeaconsInRegion(startRMData.getRegionData(), new com.qsmplibrary.altbeacon.beacon.service.Callback(startRMData.getCallbackPackageName()));
                            service.setScanPeriods(startRMData.getScanPeriod(), startRMData.getBetweenScanPeriod(), startRMData.getBackgroundFlag());
                            break;
