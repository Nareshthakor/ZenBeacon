 ...
 */
package com.qsmplibrary.altbeacon.beacon.logging;

/**
 * Logging interface for logging messages in the android-beacon-library. To set a custom logger
 * implement this interface and set it with {@link com.qsmplibrary.altbeacon.beacon.logging.LogManager#setLogger(Logger)}.
 *
 * @author Andrew Reitz
 * @see com.qsmplibrary.altbeacon.beacon.logging.LogManager
 * @since 2.2
 */
